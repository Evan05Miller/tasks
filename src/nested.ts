...
export function findQuestion(
    ...
    const correctQuestion = questions.find((question) => question.id === id);
...
export function sumPublishedPoints(questions: Question[]): number {
    const newQuestions = getPublishedQuestions(questions);
    return sumPoints(newQuestions);
}
...
export function addNewQuestion(
    ...
    const Questions = [...questions, makeBlankQuestion(id, name, type)];
    return Questions;
}
